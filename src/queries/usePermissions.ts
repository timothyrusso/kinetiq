 ...
 *
 * `notificationsGranted` lives in the settings store — seeded at boot in `bootstrap.tsx` —
 * and the workout session reads it synchronously to decide whether to arm a rest-timer
