...
// the count line is mounted but ABOVE the viewport, and `has` only reports what is visible, // it failed a run for a search that had worked perfectly (the hero read `76 exercises for
